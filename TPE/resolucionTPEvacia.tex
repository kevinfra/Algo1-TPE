...
\aux{nivelesIguales} {n1,n2: Nivel}{\bool}{ancho(n1)==ancho(n2)\land alto(n1)==alto(n2)\land turno(n1)==turno(n2) \land soles(n1)==soles(n2) \land mismos(flores(n1),flores(n2)) \land mismos(vampiros(n1),vampiros(n2))\land spawning(n1)==spawning(n2)}
\end{document}
