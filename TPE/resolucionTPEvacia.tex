...
\begin{problema}{floresN}{n : Nivel}{[(Flor, Posicion, Vida)]}
	\asegura{mismosFlores(res,flores(n))}
\end{problema}
...
\begin{problema}{comprarSoles}{n: Nivel, s : \ent}{}
	...
	\asegura{mismosFlores(flores(n),flores(pre(n)))}
...
\begin{problema}{agregarFlor}{n: Nivel, f : Flor, p : Posicion}{}
	...
	\modifica{n}
	\asegura{mismosFlores(flores(n),cons((f,p,vida(f)),(flores(pre(n)))))}
...
\aux{cuentaFlor}{f: (Flor,Posicion,Vida), lista: [(Flor,Posicion,Vida)]}{\ent}{
|[x|x \in lista,floresIguales(x,f) \land sgd(f)==sgd(x) \land trd(x)==trd(f)]|
}

\aux{mismosFlores}{f1,f2: [(Flor,Posicion,Vida)]}{\bool}{
